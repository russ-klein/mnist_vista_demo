...
//* The Dense_pv will be derived from this class.
//*
//* Model Builder version: 5.1.0
//* Generated on: Jul. 25, 2022 05:09:47 PM, (user: russk)
//*>
...
class Dense_pv_base_parameters {
 public :
  Dense_pv_base_parameters(sc_object* object);
...
class Dense_pv_base_mb_compatibility : public mb::mb_module {
  friend class Dense_pv_base;
 public:
  typedef unsigned int mb_address_type;
 protected:
  Dense_pv_base_mb_compatibility(sc_core::sc_module_name& module_name)
...
class Dense_pv_base : public Dense_pv_base_mb_compatibility,
                           public Dense_pv_base_parameters
{
  
protected:
  mb::utl::mb_debug_handler *m_mb_debug; 
private:
  typedef Dense_pv_base_mb_compatibility mb_compatibility_class;
  typedef Dense_pv_base_mb_compatibility BASE_TYPE;
 public:
  typedef esl::tlm_types::Address mb_address_type;
 public:
  typedef Dense_pv_base self;
  SC_HAS_PROCESS(Dense_pv_base);
  Dense_pv_base(sc_core::sc_module_name& module_name);
  ~Dense_pv_base();
 ...
 protected:
  ...
  mb::mb_register<unsigned int> input_image;
  mb::mb_register<unsigned int> weights;
  mb::mb_register<unsigned int> biases;
  mb::mb_register<unsigned int> output_image;
  mb::mb_register<unsigned int> num_units;
  mb::mb_register<unsigned int> unit_count;
  mb::mb_register<unsigned int> output_image_elements;
...
public:
  ...
  Dense_RemoteRegisters(SOCKET& s, uint64_t baseAddress) :
    ...
    m_input_image(s[0], baseAddress, ((0x10) / 4), ( (0) + (((0x10) % 4) << 3)), ( (31) + (((0x10) % 4) << 3))),
    ...
    m_num_units(s[0], baseAddress, ((0x20) / 4), ( (0) + (((0x20) % 4) << 3)), ( (31) + (((0x20) % 4) << 3))),
    m_unit_count(s[0], baseAddress, ((0x24) / 4), ( (0) + (((0x24) % 4) << 3)), ( (31) + (((0x24) % 4) << 3))),
    m_output_image_elements(s[0], baseAddress, ((0x28) / 4), ( (0) + (((0x28) % 4) << 3)), ( (31) + (((0x28) % 4) << 3))),
    m_relu(s[0], baseAddress, ((0x2c) / 4), ( (0) + (((0x2c) % 4) << 3)), ( (31) + (((0x2c) % 4) << 3))),
    m_bias(s[0], baseAddress, ((0x30) / 4), ( (0) + (((0x30) % 4) << 3)), ( (31) + (((0x30) % 4) << 3))),
    m_dummy(0) {}
...
public:
  ...
  mb::mb_remote_register<unsigned int, TRANS> m_input_image;
  ...
  mb::mb_remote_register<unsigned int, TRANS> m_num_units;
  mb::mb_remote_register<unsigned int, TRANS> m_unit_count;
  mb::mb_remote_register<unsigned int, TRANS> m_output_image_elements;
...
template <typename TRANS = tlm::tlm_generic_payload>
class Dense_pv_RemoteRegisters : public Dense_RemoteRegisters<TRANS> {
public:
  template <class SOCKET>
  Dense_pv_RemoteRegisters(SOCKET& s, uint64_t baseAddress)
    : Dense_RemoteRegisters<TRANS>(s, baseAddress) {
  }
};
...
//* The Dense_t will be derived from this class.
//*
//* Model Builder version: 5.1.0
//* Generated on: Jul. 25, 2022 05:09:47 PM, (user: russk)
//*>
...
#define __Dense_t_base_CLASS_EXIST__


class Dense_t_base : public papoulis::SystemCBaseModel {
public:
  static Dense_t_base* create_t(const char* _name, long simulation); 
public:
  Dense_t_base(sc_core::sc_module_name& module_name, long simulation);
...
public:
  enum register_enum {go_idx, go_ready_idx, done_idx, done_valid_idx, input_image_idx, weights_idx, biases_idx, output_image_idx, num_units_idx, unit_count_idx, output_image_elements_idx, relu_idx, bias_idx };
protected:
  ...
  mb::mb_t_register<unsigned int> input_image;
  mb::mb_t_register<unsigned int> weights;
  mb::mb_t_register<unsigned int> biases;
  mb::mb_t_register<unsigned int> output_image;
  mb::mb_t_register<unsigned int> num_units;
  mb::mb_t_register<unsigned int> unit_count;
  mb::mb_t_register<unsigned int> output_image_elements;
...
//* DO NOT MODIFY THIS FILE.
//*
//* This file contains the PVT class for Dense.
...
class Dense_pvt_param_defaults {
  
public:
  Dense_pvt_param_defaults(const char* hier_name) {
    ...
    unsigned int master_read_data_queue_size;
    unsigned int master_write_data_queue_size;
    clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("clock", sc_core::sc_time(10, sc_core::SC_NS), hier_name ,"Dense");
    signal_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("signal_clock", clock, hier_name ,"Dense");
    axi_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("axi_clock", clock, hier_name ,"Dense");
    nominal_voltage = ::mb::sysc::sdInitParameter<double>("nominal_voltage", 1, hier_name ,"Dense");
    mb_debug = ::mb::sysc::sdInitParameter<bool>("mb_debug", false, hier_name ,"Dense");
    mb_debug_start_time = ::mb::sysc::sdInitParameter<sc_core::sc_time>("mb_debug_start_time", sc_core::sc_time(0, sc_core::SC_NS), hier_name ,"Dense");
    mb_debug_end_time = ::mb::sysc::sdInitParameter<sc_core::sc_time>("mb_debug_end_time", sc_core::sc_time(0, sc_core::SC_NS), hier_name ,"Dense");
    mb_debug_address_read = ::mb::sysc::sdInitParameter<const char*>("mb_debug_address_read", "0x10:0x0", hier_name ,"Dense");
    mb_debug_address_write = ::mb::sysc::sdInitParameter<const char*>("mb_debug_address_write", "0x10:0x0", hier_name ,"Dense");
    port_enable = ::mb::sysc::sdInitParameter<bool>("port_enable", true, hier_name ,"Dense");
    call_to_default_if = ::mb::sysc::sdInitParameter<bool>("call_to_default_if", false, hier_name ,"Dense");
    verbose_parameters = ::mb::sysc::sdInitParameter<bool>("verbose_parameters", true, hier_name ,"Dense");
    dmi_enabled = ::mb::sysc::sdInitParameter<bool>("dmi_enabled", true, hier_name ,"Dense");
    warning_level = ::mb::sysc::sdInitParameter<const char*>("warning_level", "WARNING", hier_name ,"Dense");
    slave_pipeline_length = ::mb::sysc::sdInitParameter<unsigned int>("slave_pipeline_length", 2, hier_name ,"Dense");
    slave_outstanding = ::mb::sysc::sdInitParameter<unsigned int>("slave_outstanding", 1, hier_name ,"Dense");
    slave_read_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("slave_read_data_queue_size", 0, hier_name ,"Dense");
    slave_write_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("slave_write_data_queue_size", 0, hier_name ,"Dense");
    master_outstanding = ::mb::sysc::sdInitParameter<unsigned int>("master_outstanding", 1, hier_name ,"Dense");
    master_read_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("master_read_data_queue_size", 0, hier_name ,"Dense");
    master_write_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("master_write_data_queue_size", 0, hier_name ,"Dense");
    ::mb::sysc::sdPropagateParameters();
  }

  Dense_pvt_param_defaults(const char* hier_name, sc_core::sc_time clock_init, sc_core::sc_time signal_clock_init, sc_core::sc_time axi_clock_init, double nominal_voltage_init, bool mb_debug_init, sc_core::sc_time mb_debug_start_time_init, sc_core::sc_time mb_debug_end_time_init, const char* mb_debug_address_read_init, const char* mb_debug_address_write_init, bool port_enable_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int slave_pipeline_length_init, unsigned int slave_outstanding_init, unsigned int slave_read_data_queue_size_init, unsigned int slave_write_data_queue_size_init, unsigned int master_outstanding_init, unsigned int master_read_data_queue_size_init, unsigned int master_write_data_queue_size_init) {
    ...
    unsigned int master_read_data_queue_size;
    unsigned int master_write_data_queue_size;
    clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("clock", clock_init, hier_name ,"Dense");
    signal_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("signal_clock", signal_clock_init, hier_name ,"Dense");
    axi_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("axi_clock", axi_clock_init, hier_name ,"Dense");
    nominal_voltage = ::mb::sysc::sdInitParameter<double>("nominal_voltage", nominal_voltage_init, hier_name ,"Dense");
    mb_debug = ::mb::sysc::sdInitParameter<bool>("mb_debug", mb_debug_init, hier_name ,"Dense");
    mb_debug_start_time = ::mb::sysc::sdInitParameter<sc_core::sc_time>("mb_debug_start_time", mb_debug_start_time_init, hier_name ,"Dense");
    mb_debug_end_time = ::mb::sysc::sdInitParameter<sc_core::sc_time>("mb_debug_end_time", mb_debug_end_time_init, hier_name ,"Dense");
    mb_debug_address_read = ::mb::sysc::sdInitParameter<const char*>("mb_debug_address_read", mb_debug_address_read_init, hier_name ,"Dense");
    mb_debug_address_write = ::mb::sysc::sdInitParameter<const char*>("mb_debug_address_write", mb_debug_address_write_init, hier_name ,"Dense");
    port_enable = ::mb::sysc::sdInitParameter<bool>("port_enable", port_enable_init, hier_name ,"Dense");
    call_to_default_if = ::mb::sysc::sdInitParameter<bool>("call_to_default_if", call_to_default_if_init, hier_name ,"Dense");
    verbose_parameters = ::mb::sysc::sdInitParameter<bool>("verbose_parameters", verbose_parameters_init, hier_name ,"Dense");
    dmi_enabled = ::mb::sysc::sdInitParameter<bool>("dmi_enabled", dmi_enabled_init, hier_name ,"Dense");
    warning_level = ::mb::sysc::sdInitParameter<const char*>("warning_level", warning_level_init, hier_name ,"Dense");
    slave_pipeline_length = ::mb::sysc::sdInitParameter<unsigned int>("slave_pipeline_length", slave_pipeline_length_init, hier_name ,"Dense");
    slave_outstanding = ::mb::sysc::sdInitParameter<unsigned int>("slave_outstanding", slave_outstanding_init, hier_name ,"Dense");
    slave_read_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("slave_read_data_queue_size", slave_read_data_queue_size_init, hier_name ,"Dense");
    slave_write_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("slave_write_data_queue_size", slave_write_data_queue_size_init, hier_name ,"Dense");
    master_outstanding = ::mb::sysc::sdInitParameter<unsigned int>("master_outstanding", master_outstanding_init, hier_name ,"Dense");
    master_read_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("master_read_data_queue_size", master_read_data_queue_size_init, hier_name ,"Dense");
    master_write_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("master_write_data_queue_size", master_write_data_queue_size_init, hier_name ,"Dense");

    ::mb::sysc::sdPropagateParameters();
    }

  Dense_pvt_param_defaults(const char* hier_name, std::vector<std::pair<char*, unsigned int> > &change_parameters){
    ...
    for (unsigned i =0; i<change_parameters.size(); i++){
      ::mb::sysc::sdInitParameter<unsigned int>(change_parameters[i].first, change_parameters[i].second, hier_name ,"Dense");
    }
...
class Dense_pvt : public esl::sc_sim::PVTBaseModel, 
                          public mb::utl::cb_owner,
                          private Dense_pvt_param_defaults {

 public:
  typedef Dense_pvt self_type;

 public: 
  // Constructor
  Dense_pvt(sc_core::sc_module_name module_name); 
  Dense_pvt(sc_core::sc_module_name module_name, sc_core::sc_time clock_init, sc_core::sc_time signal_clock_init, sc_core::sc_time axi_clock_init, double nominal_voltage_init, bool mb_debug_init, sc_core::sc_time mb_debug_start_time_init, sc_core::sc_time mb_debug_end_time_init, const char* mb_debug_address_read_init, const char* mb_debug_address_write_init, bool port_enable_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int slave_pipeline_length_init, unsigned int slave_outstanding_init, unsigned int slave_read_data_queue_size_init, unsigned int slave_write_data_queue_size_init, unsigned int master_outstanding_init, unsigned int master_read_data_queue_size_init, unsigned int master_write_data_queue_size_init); 
  Dense_pvt(sc_core::sc_module_name module_name, std::vector<std::pair<char*, unsigned int> > &change_parameters);
  ~Dense_pvt(); 
 ...
 public:
  ...
  inline Dense_t_base* getT() const {
    return m_Dense_t;
  }

  
  //access the PV instance
  inline Dense_pv* getPV() const {
    return m_Dense_pv;
  }
 ...
 private:
  ...
  struct master_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    ...
    master_nb_connector(Dense_pvt& owner) : m_owner(owner) {
    }
  ...
  struct int_out_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    ...
    int_out_nb_connector(Dense_pvt& owner) : m_owner(owner) {
    }
    virtual tlm::tlm_sync_enum nb_transport_fw(tlm::tlm_generic_payload& trans, 
                                               tlm::tlm_phase& phase, 
                                               sc_core::sc_time& t) {
  ...
  struct slave_nb_connector : public tlm::tlm_bw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    ...
    slave_nb_connector(Dense_pvt& owner) : m_owner(owner) {
    }
