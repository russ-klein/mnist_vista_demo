...
Dense_pv_base::Dense_pv_base(sc_module_name& module_name) :
  Dense_pv_base_mb_compatibility(module_name),
  Dense_pv_base_parameters(this),
  ...
  input_image("input_image", &slave_memory, ((0x10) / 4), ( (0) + (((0x10) % 4) << 3)), ( (31) + (((0x10) % 4) << 3)),  (32), mb::tlm20::READ_WRITE_ACCESS),
  ...
  num_units("num_units", &slave_memory, ((0x20) / 4), ( (0) + (((0x20) % 4) << 3)), ( (31) + (((0x20) % 4) << 3)),  (32), mb::tlm20::READ_WRITE_ACCESS),
  unit_count("unit_count", &slave_memory, ((0x24) / 4), ( (0) + (((0x24) % 4) << 3)), ( (31) + (((0x24) % 4) << 3)),  (32), mb::tlm20::READ_WRITE_ACCESS),
  output_image_elements("output_image_elements", &slave_memory, ((0x28) / 4), ( (0) + (((0x28) % 4) << 3)), ( (31) + (((0x28) % 4) << 3)),  (32), mb::tlm20::READ_WRITE_ACCESS),
  relu("relu", &slave_memory, ((0x2c) / 4), ( (0) + (((0x2c) % 4) << 3)), ( (31) + (((0x2c) % 4) << 3)),  (32), mb::tlm20::READ_WRITE_ACCESS),
  bias("bias", &slave_memory, ((0x30) / 4), ( (0) + (((0x30) % 4) << 3)), ( (31) + (((0x30) % 4) << 3)),  (32), mb::tlm20::READ_WRITE_ACCESS) {
...
void Dense_pv_base::reset_registers() {
  // reset all registers
  unsigned u = 0;


  go.setResetValue(0);
  input_image.setResetValue(0);
  weights.setResetValue(0);
  biases.setResetValue(0);
  output_image.setResetValue(0);
  num_units.setResetValue(0);
  unit_count.setResetValue(0);
  output_image_elements.setResetValue(0);
...
void Dense_pv_base::reset_model() {
...
Dense_pv_base_parameters::Dense_pv_base_parameters(sc_object* object) :
  m_object(object),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, clock, sc_core::sc_time(10, sc_core::SC_NS), "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, signal_clock, clock, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, axi_clock, clock, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, nominal_voltage, 1, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug, false, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug_start_time, sc_core::sc_time(0, sc_core::SC_NS), "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug_end_time, sc_core::sc_time(0, sc_core::SC_NS), "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug_address_read, "0x10:0x0", "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug_address_write, "0x10:0x0", "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, port_enable, true, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, call_to_default_if, false, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, verbose_parameters, true, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, dmi_enabled, true, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, warning_level, "WARNING", "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, slave_pipeline_length, 2, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, slave_outstanding, 1, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, slave_read_data_queue_size, 0, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, slave_write_data_queue_size, 0, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, master_outstanding, 1, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, master_read_data_queue_size, 0, "Dense"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, master_write_data_queue_size, 0, "Dense")
{
  if(verbose_parameters) print_parameters();
}

void Dense_pv_base_parameters::print_parameters()
{
  const char* name;
...
void Dense_pv_base::end_of_elaboration() {
...
void Dense_t_base::schedule_axi_READ
(long port_index,
 sc_dt::uint64 delay,
...
void Dense_t_base::schedule_axi_WRITE
(long port_index,
 sc_dt::uint64 delay,
 long& transactionSize,
...
void Dense_t_base::schedule_signal_WRITE
(long port_index,
 sc_dt::uint64 delay,
 long& transactionSize,
...
void Dense_t_base::start_transaction_axi_READ
...
void Dense_t_base::end_transaction_axi_READ
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
...
void Dense_t_base::start_transaction_axi_WRITE
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
...
void Dense_t_base::end_transaction_axi_WRITE
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
...
void Dense_t_base::start_transaction_signal_WRITE
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
...
void Dense_t_base::end_transaction_signal_WRITE
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
 ...
 Dense_t_base::TransactionCallbackFunctionPointer Dense_t_base::getTransactionCallback(unsigned callbackIndex) {
  static TransactionCallbackFunctionPointer funcArray[] = {
    static_cast<TransactionCallbackFunctionPointer>(&Dense_t_base::start_transaction_axi_READ),
    static_cast<TransactionCallbackFunctionPointer>(&Dense_t_base::start_transaction_axi_WRITE),
    static_cast<TransactionCallbackFunctionPointer>(&Dense_t_base::start_transaction_axi_READ),
    static_cast<TransactionCallbackFunctionPointer>(&Dense_t_base::start_transaction_axi_WRITE),
    static_cast<TransactionCallbackFunctionPointer>(&Dense_t_base::null_transaction_callback),
    static_cast<TransactionCallbackFunctionPointer>(&Dense_t_base::start_transaction_signal_WRITE),
    static_cast<TransactionCallbackFunctionPointer>(&Dense_t_base::end_transaction_axi_READ),
    static_cast<TransactionCallbackFunctionPointer>(&Dense_t_base::end_transaction_axi_WRITE),
    static_cast<TransactionCallbackFunctionPointer>(&Dense_t_base::end_transaction_axi_READ),
    static_cast<TransactionCallbackFunctionPointer>(&Dense_t_base::end_transaction_axi_WRITE),
    static_cast<TransactionCallbackFunctionPointer>(&Dense_t_base::null_transaction_callback),
    static_cast<TransactionCallbackFunctionPointer>(&Dense_t_base::end_transaction_signal_WRITE),
    0
  };
...
config::real80 Dense_t_base::get_state_power() {
...
Dense_t_base::Dense_t_base(sc_module_name& module_name, long simulation) :
  papoulis::SystemCBaseModel(module_name),
  SD_INITIALIZE_PARAMETER(clock, sc_core::sc_time(10, sc_core::SC_NS), "Dense"),
  SD_INITIALIZE_PARAMETER(signal_clock, clock, "Dense"),
  SD_INITIALIZE_PARAMETER(axi_clock, clock, "Dense"),
  SD_INITIALIZE_PARAMETER(nominal_voltage, 1, "Dense"),
  SD_INITIALIZE_PARAMETER(mb_debug, false, "Dense"),
  SD_INITIALIZE_PARAMETER(mb_debug_start_time, sc_core::sc_time(0, sc_core::SC_NS), "Dense"),
  SD_INITIALIZE_PARAMETER(mb_debug_end_time, sc_core::sc_time(0, sc_core::SC_NS), "Dense"),
  SD_INITIALIZE_PARAMETER(mb_debug_address_read, "0x10:0x0", "Dense"),
  SD_INITIALIZE_PARAMETER(mb_debug_address_write, "0x10:0x0", "Dense"),
  SD_INITIALIZE_PARAMETER(port_enable, true, "Dense"),
  SD_INITIALIZE_PARAMETER(call_to_default_if, false, "Dense"),
  SD_INITIALIZE_PARAMETER(verbose_parameters, true, "Dense"),
  SD_INITIALIZE_PARAMETER(dmi_enabled, true, "Dense"),
  SD_INITIALIZE_PARAMETER(warning_level, "WARNING", "Dense"),
  SD_INITIALIZE_PARAMETER(slave_pipeline_length, 2, "Dense"),
  SD_INITIALIZE_PARAMETER(slave_outstanding, 1, "Dense"),
  SD_INITIALIZE_PARAMETER(slave_read_data_queue_size, 0, "Dense"),
  SD_INITIALIZE_PARAMETER(slave_write_data_queue_size, 0, "Dense"),
  SD_INITIALIZE_PARAMETER(master_outstanding, 1, "Dense"),
  SD_INITIALIZE_PARAMETER(master_read_data_queue_size, 0, "Dense"),
  SD_INITIALIZE_PARAMETER(master_write_data_queue_size, 0, "Dense"),
  m_simulation(simulation),
  go("go", this),
  go_ready("go_ready", this),
  done("done", this),
  done_valid("done_valid", this),
  input_image("input_image", this),
  weights("weights", this),
  biases("biases", this),
  output_image("output_image", this),
  num_units("num_units", this),
  unit_count("unit_count", this),
  output_image_elements("output_image_elements", this),
  relu("relu", this),
  bias("bias", this)
{
...
void Dense_t_base::update_sync_all() {
  set_sync_all(0);
  
}


void Dense_t_base::update_pipeline_parameters(esl::sc_sim::pipeline_policy* handle) {
...
void Dense_t_base::update_sequential_parameters(esl::sc_sim::sequential_policy* handle) {
...
void Dense_t_base::update_delay_parameters(esl::sc_sim::delay_policy* handle) {
...
void Dense_t_base::update_bus_parameters(esl::sc_sim::uniform_bus_policy* handle) {
...
void Dense_t_base::update_power_parameters(esl::sc_sim::power_policy* handle) {
...
void Dense_t_base::update_state_power_parameters(esl::sc_sim::state_power_policy* handle) {
...
void Dense_t_base::update_global_power_parameters(esl::sc_sim::constant_global_power_policy* handle) {
...
bool Dense_t_base::triggerRegistersGotHit(unsigned portIndex, tlm::tlm_generic_payload& trans) {
...
bool Dense_t_base::portHasRegisters(unsigned portIndex) {
  switch (portIndex) {
...
unsigned Dense_t_base::getPortCountForRegister(unsigned regIndex) {
  ...
  if (!strcmp(get_register_name(regIndex), "done_valid"))
    return 1;
  if (!strcmp(get_register_name(regIndex), "input_image"))
    return 1;
  ...
  if (!strcmp(get_register_name(regIndex), "output_image"))
    return 1;
  if (!strcmp(get_register_name(regIndex), "num_units"))
    return 1;
  if (!strcmp(get_register_name(regIndex), "unit_count"))
    return 1;
  if (!strcmp(get_register_name(regIndex), "output_image_elements"))
    return 1;
...
void Dense_t_base::getPortNamesForRegister(unsigned regIndex, const char **names) {
  long i = 0;
  if (!strcmp(get_register_name(regIndex), "go")) {
    names[i++] = "slave";
    return;
...
Dense_pvt::Dense_pvt(sc_module_name module_name)
  : esl::sc_sim::PVTBaseModel(module_name, 0),
    Dense_pvt_param_defaults(this->name()),
    master("master"),
    slave("slave"),
    int_out("int_out"),
...
Dense_pvt::Dense_pvt(sc_module_name module_name,  std::vector<std::pair<char*, unsigned int> > &change_parameters)
  : esl::sc_sim::PVTBaseModel(module_name, 0),
  Dense_pvt_param_defaults(this->name(), change_parameters),
    master("master"),
    slave("slave"),
    int_out("int_out"),
    master_entry("unvisible_master_entry"),
...
void Dense_pvt::b_transport_outside_master(tlm::tlm_generic_payload& p, sc_core::sc_time& t)
{
...
unsigned int Dense_pvt::transport_dbg_outside_master(tlm::tlm_generic_payload& p)
{
...
void
Dense_pvt::b_transport_outside_int_out(bool data)
{
  ...
  mb::mb_module* current_model = dynamic_cast<mb::mb_module*>(m_Dense_pv);
  if (current_model)
