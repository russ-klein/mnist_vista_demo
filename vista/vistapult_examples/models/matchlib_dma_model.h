...
//* The matchlib_dma_pv will be derived from this class.
//*
//* Model Builder version: 5.1.0
//* Generated on: Mar. 16, 2022 11:52:54 AM, (user: russk)
//*>
...
class matchlib_dma_pv_base_parameters {
 public :
  matchlib_dma_pv_base_parameters(sc_object* object);
...
class matchlib_dma_pv_base;


class matchlib_dma_pv_base_mb_compatibility : public mb::mb_module {
  friend class matchlib_dma_pv_base;
 public:
  typedef unsigned int mb_address_type;
 protected:
  matchlib_dma_pv_base_mb_compatibility(sc_core::sc_module_name& module_name)
...
class matchlib_dma_pv_base : public matchlib_dma_pv_base_mb_compatibility,
                           public matchlib_dma_pv_base_parameters
{
  
protected:
  mb::utl::mb_debug_handler *m_mb_debug; 
private:
  typedef matchlib_dma_pv_base_mb_compatibility mb_compatibility_class;
  typedef matchlib_dma_pv_base_mb_compatibility BASE_TYPE;
 public:
  typedef esl::tlm_types::Address mb_address_type;
 public:
  typedef matchlib_dma_pv_base self;
  SC_HAS_PROCESS(matchlib_dma_pv_base);
  matchlib_dma_pv_base(sc_core::sc_module_name& module_name);
  ~matchlib_dma_pv_base();
 ...
 protected:
  ...
  virtual void cb_write_source(unsigned int newValue) = 0;
  virtual void cb_write_destination(unsigned int newValue) = 0;
  virtual void cb_write_size(unsigned int newValue) = 0;
...
class matchlib_dma_RemoteRegisters {
...
public:
  ...
  matchlib_dma_RemoteRegisters(SOCKET& s, uint64_t baseAddress) :
...
template <typename TRANS = tlm::tlm_generic_payload>
class matchlib_dma_pv_RemoteRegisters : public matchlib_dma_RemoteRegisters<TRANS> {
public:
  template <class SOCKET>
  matchlib_dma_pv_RemoteRegisters(SOCKET& s, uint64_t baseAddress)
    : matchlib_dma_RemoteRegisters<TRANS>(s, baseAddress) {
  }
};
...
//* The matchlib_dma_t will be derived from this class.
//*
//* Model Builder version: 5.1.0
//* Generated on: Mar. 16, 2022 11:52:54 AM, (user: russk)
//*>
...
#define __matchlib_dma_t_base_CLASS_EXIST__


class matchlib_dma_t_base : public papoulis::SystemCBaseModel {
public:
  static matchlib_dma_t_base* create_t(const char* _name, long simulation); 
public:
  matchlib_dma_t_base(sc_core::sc_module_name& module_name, long simulation);
...
protected:
  friend class matchlib_dma_model;
...
//* DO NOT MODIFY THIS FILE.
//*
//* This file contains the PVT class for matchlib_dma.
...
class matchlib_dma_pv;



using namespace std;

class matchlib_dma_pvt_param_defaults {
  
public:
  matchlib_dma_pvt_param_defaults(const char* hier_name) {
    ...
    unsigned int master_read_data_queue_size;
    unsigned int master_write_data_queue_size;
    clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("clock", sc_core::sc_time(10, sc_core::SC_NS), hier_name ,"matchlib_dma");
    signal_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("signal_clock", clock, hier_name ,"matchlib_dma");
    axi_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("axi_clock", clock, hier_name ,"matchlib_dma");
    nominal_voltage = ::mb::sysc::sdInitParameter<double>("nominal_voltage", 1, hier_name ,"matchlib_dma");
    mb_debug = ::mb::sysc::sdInitParameter<bool>("mb_debug", false, hier_name ,"matchlib_dma");
    mb_debug_start_time = ::mb::sysc::sdInitParameter<sc_core::sc_time>("mb_debug_start_time", sc_core::sc_time(0, sc_core::SC_NS), hier_name ,"matchlib_dma");
    mb_debug_end_time = ::mb::sysc::sdInitParameter<sc_core::sc_time>("mb_debug_end_time", sc_core::sc_time(0, sc_core::SC_NS), hier_name ,"matchlib_dma");
    mb_debug_address_read = ::mb::sysc::sdInitParameter<const char*>("mb_debug_address_read", "0x10:0x0", hier_name ,"matchlib_dma");
    mb_debug_address_write = ::mb::sysc::sdInitParameter<const char*>("mb_debug_address_write", "0x10:0x0", hier_name ,"matchlib_dma");
    port_enable = ::mb::sysc::sdInitParameter<bool>("port_enable", true, hier_name ,"matchlib_dma");
    call_to_default_if = ::mb::sysc::sdInitParameter<bool>("call_to_default_if", false, hier_name ,"matchlib_dma");
    verbose_parameters = ::mb::sysc::sdInitParameter<bool>("verbose_parameters", true, hier_name ,"matchlib_dma");
    dmi_enabled = ::mb::sysc::sdInitParameter<bool>("dmi_enabled", true, hier_name ,"matchlib_dma");
    warning_level = ::mb::sysc::sdInitParameter<const char*>("warning_level", "WARNING", hier_name ,"matchlib_dma");
    slave_pipeline_length = ::mb::sysc::sdInitParameter<unsigned int>("slave_pipeline_length", 2, hier_name ,"matchlib_dma");
    slave_outstanding = ::mb::sysc::sdInitParameter<unsigned int>("slave_outstanding", 1, hier_name ,"matchlib_dma");
    slave_read_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("slave_read_data_queue_size", 0, hier_name ,"matchlib_dma");
    slave_write_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("slave_write_data_queue_size", 0, hier_name ,"matchlib_dma");
    master_outstanding = ::mb::sysc::sdInitParameter<unsigned int>("master_outstanding", 1, hier_name ,"matchlib_dma");
    master_read_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("master_read_data_queue_size", 0, hier_name ,"matchlib_dma");
    master_write_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("master_write_data_queue_size", 0, hier_name ,"matchlib_dma");
    ::mb::sysc::sdPropagateParameters();
  }

  matchlib_dma_pvt_param_defaults(const char* hier_name, sc_core::sc_time clock_init, sc_core::sc_time signal_clock_init, sc_core::sc_time axi_clock_init, double nominal_voltage_init, bool mb_debug_init, sc_core::sc_time mb_debug_start_time_init, sc_core::sc_time mb_debug_end_time_init, const char* mb_debug_address_read_init, const char* mb_debug_address_write_init, bool port_enable_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int slave_pipeline_length_init, unsigned int slave_outstanding_init, unsigned int slave_read_data_queue_size_init, unsigned int slave_write_data_queue_size_init, unsigned int master_outstanding_init, unsigned int master_read_data_queue_size_init, unsigned int master_write_data_queue_size_init) {
    ...
    unsigned int master_read_data_queue_size;
    unsigned int master_write_data_queue_size;
    clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("clock", clock_init, hier_name ,"matchlib_dma");
    signal_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("signal_clock", signal_clock_init, hier_name ,"matchlib_dma");
    axi_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("axi_clock", axi_clock_init, hier_name ,"matchlib_dma");
    nominal_voltage = ::mb::sysc::sdInitParameter<double>("nominal_voltage", nominal_voltage_init, hier_name ,"matchlib_dma");
    mb_debug = ::mb::sysc::sdInitParameter<bool>("mb_debug", mb_debug_init, hier_name ,"matchlib_dma");
    mb_debug_start_time = ::mb::sysc::sdInitParameter<sc_core::sc_time>("mb_debug_start_time", mb_debug_start_time_init, hier_name ,"matchlib_dma");
    mb_debug_end_time = ::mb::sysc::sdInitParameter<sc_core::sc_time>("mb_debug_end_time", mb_debug_end_time_init, hier_name ,"matchlib_dma");
    mb_debug_address_read = ::mb::sysc::sdInitParameter<const char*>("mb_debug_address_read", mb_debug_address_read_init, hier_name ,"matchlib_dma");
    mb_debug_address_write = ::mb::sysc::sdInitParameter<const char*>("mb_debug_address_write", mb_debug_address_write_init, hier_name ,"matchlib_dma");
    port_enable = ::mb::sysc::sdInitParameter<bool>("port_enable", port_enable_init, hier_name ,"matchlib_dma");
    call_to_default_if = ::mb::sysc::sdInitParameter<bool>("call_to_default_if", call_to_default_if_init, hier_name ,"matchlib_dma");
    verbose_parameters = ::mb::sysc::sdInitParameter<bool>("verbose_parameters", verbose_parameters_init, hier_name ,"matchlib_dma");
    dmi_enabled = ::mb::sysc::sdInitParameter<bool>("dmi_enabled", dmi_enabled_init, hier_name ,"matchlib_dma");
    warning_level = ::mb::sysc::sdInitParameter<const char*>("warning_level", warning_level_init, hier_name ,"matchlib_dma");
    slave_pipeline_length = ::mb::sysc::sdInitParameter<unsigned int>("slave_pipeline_length", slave_pipeline_length_init, hier_name ,"matchlib_dma");
    slave_outstanding = ::mb::sysc::sdInitParameter<unsigned int>("slave_outstanding", slave_outstanding_init, hier_name ,"matchlib_dma");
    slave_read_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("slave_read_data_queue_size", slave_read_data_queue_size_init, hier_name ,"matchlib_dma");
    slave_write_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("slave_write_data_queue_size", slave_write_data_queue_size_init, hier_name ,"matchlib_dma");
    master_outstanding = ::mb::sysc::sdInitParameter<unsigned int>("master_outstanding", master_outstanding_init, hier_name ,"matchlib_dma");
    master_read_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("master_read_data_queue_size", master_read_data_queue_size_init, hier_name ,"matchlib_dma");
    master_write_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("master_write_data_queue_size", master_write_data_queue_size_init, hier_name ,"matchlib_dma");

    ::mb::sysc::sdPropagateParameters();
    }

  matchlib_dma_pvt_param_defaults(const char* hier_name, std::vector<std::pair<char*, unsigned int> > &change_parameters){
    ...
    for (unsigned i =0; i<change_parameters.size(); i++){
      ::mb::sysc::sdInitParameter<unsigned int>(change_parameters[i].first, change_parameters[i].second, hier_name ,"matchlib_dma");
    }
...
class matchlib_dma_pvt : public esl::sc_sim::PVTBaseModel, 
                          public mb::utl::cb_owner,
                          private matchlib_dma_pvt_param_defaults {

 public:
  typedef matchlib_dma_pvt self_type;

 public: 
  // Constructor
  matchlib_dma_pvt(sc_core::sc_module_name module_name); 
  matchlib_dma_pvt(sc_core::sc_module_name module_name, sc_core::sc_time clock_init, sc_core::sc_time signal_clock_init, sc_core::sc_time axi_clock_init, double nominal_voltage_init, bool mb_debug_init, sc_core::sc_time mb_debug_start_time_init, sc_core::sc_time mb_debug_end_time_init, const char* mb_debug_address_read_init, const char* mb_debug_address_write_init, bool port_enable_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int slave_pipeline_length_init, unsigned int slave_outstanding_init, unsigned int slave_read_data_queue_size_init, unsigned int slave_write_data_queue_size_init, unsigned int master_outstanding_init, unsigned int master_read_data_queue_size_init, unsigned int master_write_data_queue_size_init); 
  matchlib_dma_pvt(sc_core::sc_module_name module_name, std::vector<std::pair<char*, unsigned int> > &change_parameters);
  ~matchlib_dma_pvt(); 
 ...
 public:
  ...
  inline matchlib_dma_t_base* getT() const {
    return m_matchlib_dma_t;
  }

  
  //access the PV instance
  inline matchlib_dma_pv* getPV() const {
    return m_matchlib_dma_pv;
  }
 ...
 private:
  ...
  //T instance
  matchlib_dma_t_base* m_matchlib_dma_t;
  
  
  //PV instance
  matchlib_dma_pv* m_matchlib_dma_pv;
 ...
 private:
  ...
  struct master_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    matchlib_dma_pvt& m_owner;
    
    master_nb_connector(matchlib_dma_pvt& owner) : m_owner(owner) {
    }
  ...
  struct irq_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    ...
    irq_nb_connector(matchlib_dma_pvt& owner) : m_owner(owner) {
    }
    virtual tlm::tlm_sync_enum nb_transport_fw(tlm::tlm_generic_payload& trans, 
                                               tlm::tlm_phase& phase, 
                                               sc_core::sc_time& t) {
  ...
  struct slave_nb_connector : public tlm::tlm_bw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    ...
    slave_nb_connector(matchlib_dma_pvt& owner) : m_owner(owner) {
    }
