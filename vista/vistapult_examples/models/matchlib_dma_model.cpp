...
matchlib_dma_pv_base::matchlib_dma_pv_base(sc_module_name& module_name) :
  matchlib_dma_pv_base_mb_compatibility(module_name),
  matchlib_dma_pv_base_parameters(this),
  ...
  done("done", &slave_memory, ((16) / 4), ( (0) + (((16) % 4) << 3)), ( (31) + (((16) % 4) << 3)),  (32), mb::tlm20::READ_WRITE_ACCESS),
  ...
  VISTA_MB_PV_SET_SELF_TRANSPORT_DBG(source);
  VISTA_MB_PV_SET_SELF_TRANSPORT_DBG(destination);
  VISTA_MB_PV_SET_SELF_TRANSPORT_DBG(size);
  VISTA_MB_PV_SET_SELF_TRANSPORT_DBG(go);
  VISTA_MB_PV_SET_SELF_TRANSPORT_DBG(irq_ack);
  VISTA_MB_PV_SET_SELF_WRITE_CB(source);
  VISTA_MB_PV_SET_SELF_WRITE_CB(destination);
  VISTA_MB_PV_SET_SELF_WRITE_CB(size);
...
matchlib_dma_pv_base::~matchlib_dma_pv_base() {
...
void matchlib_dma_pv_base::reset_registers() {
  // reset all registers
  unsigned u = 0;
...
void matchlib_dma_pv_base::reset_model() {
...
matchlib_dma_pv_base_parameters::matchlib_dma_pv_base_parameters(sc_object* object) :
  m_object(object),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, clock, sc_core::sc_time(10, sc_core::SC_NS), "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, signal_clock, clock, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, axi_clock, clock, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, nominal_voltage, 1, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug, false, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug_start_time, sc_core::sc_time(0, sc_core::SC_NS), "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug_end_time, sc_core::sc_time(0, sc_core::SC_NS), "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug_address_read, "0x10:0x0", "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug_address_write, "0x10:0x0", "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, port_enable, true, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, call_to_default_if, false, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, verbose_parameters, true, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, dmi_enabled, true, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, warning_level, "WARNING", "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, slave_pipeline_length, 2, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, slave_outstanding, 1, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, slave_read_data_queue_size, 0, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, slave_write_data_queue_size, 0, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, master_outstanding, 1, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, master_read_data_queue_size, 0, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, master_write_data_queue_size, 0, "matchlib_dma")
{
  if(verbose_parameters) print_parameters();
}

void matchlib_dma_pv_base_parameters::print_parameters()
{
  const char* name;
...
void matchlib_dma_pv_base::end_of_elaboration() {
...
void matchlib_dma_t_base::schedule_axi_READ
(long port_index,
 sc_dt::uint64 delay,
...
void matchlib_dma_t_base::schedule_axi_WRITE
(long port_index,
 sc_dt::uint64 delay,
 long& transactionSize,
...
void matchlib_dma_t_base::schedule_signal_WRITE
(long port_index,
 sc_dt::uint64 delay,
 long& transactionSize,
...
void matchlib_dma_t_base::start_transaction_axi_READ
...
void matchlib_dma_t_base::end_transaction_axi_READ
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
...
void matchlib_dma_t_base::start_transaction_axi_WRITE
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
...
void matchlib_dma_t_base::end_transaction_axi_WRITE
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
...
void matchlib_dma_t_base::start_transaction_signal_WRITE
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
...
void matchlib_dma_t_base::end_transaction_signal_WRITE
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
 ...
 matchlib_dma_t_base::TransactionCallbackFunctionPointer matchlib_dma_t_base::getTransactionCallback(unsigned callbackIndex) {
  static TransactionCallbackFunctionPointer funcArray[] = {
    static_cast<TransactionCallbackFunctionPointer>(&matchlib_dma_t_base::start_transaction_axi_READ),
    static_cast<TransactionCallbackFunctionPointer>(&matchlib_dma_t_base::start_transaction_axi_WRITE),
    static_cast<TransactionCallbackFunctionPointer>(&matchlib_dma_t_base::start_transaction_axi_READ),
    static_cast<TransactionCallbackFunctionPointer>(&matchlib_dma_t_base::start_transaction_axi_WRITE),
    static_cast<TransactionCallbackFunctionPointer>(&matchlib_dma_t_base::null_transaction_callback),
    static_cast<TransactionCallbackFunctionPointer>(&matchlib_dma_t_base::start_transaction_signal_WRITE),
    static_cast<TransactionCallbackFunctionPointer>(&matchlib_dma_t_base::end_transaction_axi_READ),
    static_cast<TransactionCallbackFunctionPointer>(&matchlib_dma_t_base::end_transaction_axi_WRITE),
    static_cast<TransactionCallbackFunctionPointer>(&matchlib_dma_t_base::end_transaction_axi_READ),
    static_cast<TransactionCallbackFunctionPointer>(&matchlib_dma_t_base::end_transaction_axi_WRITE),
    static_cast<TransactionCallbackFunctionPointer>(&matchlib_dma_t_base::null_transaction_callback),
    static_cast<TransactionCallbackFunctionPointer>(&matchlib_dma_t_base::end_transaction_signal_WRITE),
    0
  };
...
config::real80 matchlib_dma_t_base::get_state_power() {
...
matchlib_dma_t_base::matchlib_dma_t_base(sc_module_name& module_name, long simulation) :
  papoulis::SystemCBaseModel(module_name),
  SD_INITIALIZE_PARAMETER(clock, sc_core::sc_time(10, sc_core::SC_NS), "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(signal_clock, clock, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(axi_clock, clock, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(nominal_voltage, 1, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(mb_debug, false, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(mb_debug_start_time, sc_core::sc_time(0, sc_core::SC_NS), "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(mb_debug_end_time, sc_core::sc_time(0, sc_core::SC_NS), "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(mb_debug_address_read, "0x10:0x0", "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(mb_debug_address_write, "0x10:0x0", "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(port_enable, true, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(call_to_default_if, false, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(verbose_parameters, true, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(dmi_enabled, true, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(warning_level, "WARNING", "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(slave_pipeline_length, 2, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(slave_outstanding, 1, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(slave_read_data_queue_size, 0, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(slave_write_data_queue_size, 0, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(master_outstanding, 1, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(master_read_data_queue_size, 0, "matchlib_dma"),
  SD_INITIALIZE_PARAMETER(master_write_data_queue_size, 0, "matchlib_dma"),
...
void matchlib_dma_t_base::update_sync_all() {
  set_sync_all(0);
  set_sync_all(0);
}


void matchlib_dma_t_base::update_pipeline_parameters(esl::sc_sim::pipeline_policy* handle) {
...
void matchlib_dma_t_base::update_sequential_parameters(esl::sc_sim::sequential_policy* handle) {
...
void matchlib_dma_t_base::update_delay_parameters(esl::sc_sim::delay_policy* handle) {
...
void matchlib_dma_t_base::update_bus_parameters(esl::sc_sim::uniform_bus_policy* handle) {
...
void matchlib_dma_t_base::update_power_parameters(esl::sc_sim::power_policy* handle) {
...
void matchlib_dma_t_base::update_state_power_parameters(esl::sc_sim::state_power_policy* handle) {
...
void matchlib_dma_t_base::update_global_power_parameters(esl::sc_sim::constant_global_power_policy* handle) {
...
bool matchlib_dma_t_base::triggerRegistersGotHit(unsigned portIndex, tlm::tlm_generic_payload& trans) {
  ...
  {
    if (0 == portIndex) {
      mb::utl::Segment<uint64_t> current((1 + ((4 % 4) << 3)), (1 + ((4 % 4) << 3)));
      mb::utl::Segment<uint64_t> intersect = transactionRange.intersect(current);
      if (!intersect.empty())
        return true;
    }
  ...
  {
    if (0 == portIndex) {
      mb::utl::Segment<uint64_t> current((1 + ((8 % 4) << 3)), (1 + ((8 % 4) << 3)));
      mb::utl::Segment<uint64_t> intersect = transactionRange.intersect(current);
      if (!intersect.empty())
        return true;
    }
...
bool matchlib_dma_t_base::portHasRegisters(unsigned portIndex) {
  switch (portIndex) {
...
unsigned matchlib_dma_t_base::getPortCountForRegister(unsigned regIndex) {
...
void matchlib_dma_t_base::getPortNamesForRegister(unsigned regIndex, const char **names) {
  long i = 0;
  if (!strcmp(get_register_name(regIndex), "source")) {
    names[i++] = "slave";
    return;
...
matchlib_dma_pvt::matchlib_dma_pvt(sc_module_name module_name)
  : esl::sc_sim::PVTBaseModel(module_name, 0),
    matchlib_dma_pvt_param_defaults(this->name()),
    master("master"),
    slave("slave"),
    irq("irq"),
...

{
  ...
  m_matchlib_dma_t = matchlib_dma_t_base::create_t("T", 1);
  m_matchlib_dma_pv = new matchlib_dma_pv("PV");
  bind();
}  
...
matchlib_dma_pvt::matchlib_dma_pvt(sc_module_name module_name,  std::vector<std::pair<char*, unsigned int> > &change_parameters)
  : esl::sc_sim::PVTBaseModel(module_name, 0),
  matchlib_dma_pvt_param_defaults(this->name(), change_parameters),
    master("master"),
    slave("slave"),
    irq("irq"),
    master_entry("unvisible_master_entry"),
...
matchlib_dma_pvt::~matchlib_dma_pvt() {
  remove_pending_scenes();
  
  delete m_matchlib_dma_t;
  
  delete m_matchlib_dma_pv;
}
...
void matchlib_dma_pvt::bind()
{
  ...
  m_matchlib_dma_t->check_mb_events();
...
void matchlib_dma_pvt::b_transport_outside_master(tlm::tlm_generic_payload& p, sc_core::sc_time& t)
{
...
unsigned int matchlib_dma_pvt::transport_dbg_outside_master(tlm::tlm_generic_payload& p)
{
...
void
matchlib_dma_pvt::b_transport_outside_irq(bool data)
{
  ...
  mb::mb_module* current_model = dynamic_cast<mb::mb_module*>(m_matchlib_dma_pv);
  if (current_model)
