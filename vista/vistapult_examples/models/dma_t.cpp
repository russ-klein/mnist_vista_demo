...
//*
//* This file contains the timing class for dma.
//*
...
#ifdef __dma_t_base_CLASS_EXIST__
#include <iostream>
...
dma_t_base* dma_t_base::create_t(const char* name, long simulation) {
  return new dma_t(name, simulation);
}


dma_t::dma_t(sc_module_name _name, long simulation)
  : dma_t_base(_name, simulation) {
