...
console_out_pv_base::console_out_pv_base(sc_module_name& module_name) :
  console_out_pv_base_mb_compatibility(module_name),
  console_out_pv_base_parameters(this),
  VISTA_MB_PV_INIT_MEMBER(slave),
  VISTA_MB_PV_INIT_MEMBER(slave_memory),
  char_out("char_out", &slave_memory, ((0x00) / 4), ( (0) + (((0x00) % 4) << 3)), ( (31) + (((0x00) % 4) << 3)),  (32), mb::tlm20::READ_WRITE_ACCESS),
  char_ready("char_ready", &slave_memory, ((0x18) / 4), ( (0) + (((0x18) % 4) << 3)), ( (31) + (((0x18) % 4) << 3)),  (32), mb::tlm20::READ_WRITE_ACCESS),
  end_sim("end_sim", &slave_memory, ((0xFFF0) / 4), ( (0) + (((0xFFF0) % 4) << 3)), ( (31) + (((0xFFF0) % 4) << 3)),  (32), mb::tlm20::READ_WRITE_ACCESS) {
  ...
  VISTA_MB_PV_SET_SELF_TRANSPORT_DBG(char_out);
  VISTA_MB_PV_SET_SELF_TRANSPORT_DBG(end_sim);
  VISTA_MB_PV_SET_SELF_WRITE_CB(char_out);
  VISTA_MB_PV_SET_SELF_WRITE_CB(end_sim);
...
console_out_pv_base::~console_out_pv_base() {
...
void console_out_pv_base::reset_registers() {
  // reset all registers
  unsigned u = 0;


  char_out.setResetValue(0);
  char_ready.setResetValue(0);
  end_sim.setResetValue(0);
}


void console_out_pv_base::reset_model() {
...
console_out_pv_base_parameters::console_out_pv_base_parameters(sc_object* object) :
  m_object(object),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, clock, sc_core::sc_time(10, sc_core::SC_NS), "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, axi_clock, clock, "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, nominal_voltage, 1, "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug, false, "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug_start_time, sc_core::sc_time(0, sc_core::SC_NS), "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug_end_time, sc_core::sc_time(0, sc_core::SC_NS), "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug_address_read, "0x10:0x0", "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, mb_debug_address_write, "0x10:0x0", "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, port_enable, true, "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, call_to_default_if, false, "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, verbose_parameters, true, "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, dmi_enabled, true, "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, warning_level, "WARNING", "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, slave_pipeline_length, 2, "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, slave_outstanding, 1, "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, slave_read_data_queue_size, 0, "console_out"),
  SD_INITIALIZE_PARAMETER_EXTERNALLY(object, slave_write_data_queue_size, 0, "console_out")
{
  if(verbose_parameters) print_parameters();
}

void console_out_pv_base_parameters::print_parameters()
{
  const char* name;
...
void console_out_pv_base::end_of_elaboration() {
...
void console_out_t_base::start_transaction_axi_READ
...
void console_out_t_base::end_transaction_axi_READ
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
...
void console_out_t_base::start_transaction_axi_WRITE
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
...
void console_out_t_base::end_transaction_axi_WRITE
(esl::include::TRequest* request,
 unsigned port_index,
 sc_dt::uint64 startTime,
 sc_dt::uint64 endTime,
 ...
 console_out_t_base::TransactionCallbackFunctionPointer console_out_t_base::getTransactionCallback(unsigned callbackIndex) {
  static TransactionCallbackFunctionPointer funcArray[] = {
    static_cast<TransactionCallbackFunctionPointer>(&console_out_t_base::start_transaction_axi_READ),
    static_cast<TransactionCallbackFunctionPointer>(&console_out_t_base::start_transaction_axi_WRITE),
    static_cast<TransactionCallbackFunctionPointer>(&console_out_t_base::end_transaction_axi_READ),
    static_cast<TransactionCallbackFunctionPointer>(&console_out_t_base::end_transaction_axi_WRITE),
    0
  };
...
config::real80 console_out_t_base::get_state_power() {
...
console_out_t_base::console_out_t_base(sc_module_name& module_name, long simulation) :
  papoulis::SystemCBaseModel(module_name),
  SD_INITIALIZE_PARAMETER(clock, sc_core::sc_time(10, sc_core::SC_NS), "console_out"),
  SD_INITIALIZE_PARAMETER(axi_clock, clock, "console_out"),
  SD_INITIALIZE_PARAMETER(nominal_voltage, 1, "console_out"),
  SD_INITIALIZE_PARAMETER(mb_debug, false, "console_out"),
  SD_INITIALIZE_PARAMETER(mb_debug_start_time, sc_core::sc_time(0, sc_core::SC_NS), "console_out"),
  SD_INITIALIZE_PARAMETER(mb_debug_end_time, sc_core::sc_time(0, sc_core::SC_NS), "console_out"),
  SD_INITIALIZE_PARAMETER(mb_debug_address_read, "0x10:0x0", "console_out"),
  SD_INITIALIZE_PARAMETER(mb_debug_address_write, "0x10:0x0", "console_out"),
  SD_INITIALIZE_PARAMETER(port_enable, true, "console_out"),
  SD_INITIALIZE_PARAMETER(call_to_default_if, false, "console_out"),
  SD_INITIALIZE_PARAMETER(verbose_parameters, true, "console_out"),
  SD_INITIALIZE_PARAMETER(dmi_enabled, true, "console_out"),
  SD_INITIALIZE_PARAMETER(warning_level, "WARNING", "console_out"),
  SD_INITIALIZE_PARAMETER(slave_pipeline_length, 2, "console_out"),
  SD_INITIALIZE_PARAMETER(slave_outstanding, 1, "console_out"),
  SD_INITIALIZE_PARAMETER(slave_read_data_queue_size, 0, "console_out"),
  SD_INITIALIZE_PARAMETER(slave_write_data_queue_size, 0, "console_out"),
  m_simulation(simulation),
  char_out("char_out", this),
  char_ready("char_ready", this),
  end_sim("end_sim", this)
{
...
void console_out_t_base::update_sync_all() {
  set_sync_all(0);
  
}


void console_out_t_base::update_pipeline_parameters(esl::sc_sim::pipeline_policy* handle) {
...
void console_out_t_base::update_sequential_parameters(esl::sc_sim::sequential_policy* handle) {
...
void console_out_t_base::update_delay_parameters(esl::sc_sim::delay_policy* handle) {
...
void console_out_t_base::update_bus_parameters(esl::sc_sim::uniform_bus_policy* handle) {
...
void console_out_t_base::update_power_parameters(esl::sc_sim::power_policy* handle) {
...
void console_out_t_base::update_state_power_parameters(esl::sc_sim::state_power_policy* handle) {
...
void console_out_t_base::update_global_power_parameters(esl::sc_sim::constant_global_power_policy* handle) {
...
bool console_out_t_base::triggerRegistersGotHit(unsigned portIndex, tlm::tlm_generic_payload& trans) {
  mb::utl::Segment<uint64_t> transactionRange(trans.get_address(), trans.get_address() + trans.get_data_length());

  {
    if (0 == portIndex) {
      mb::utl::Segment<uint64_t> current((1 + ((0x00 % 4) << 3)), (1 + ((0x00 % 4) << 3)));
  ...
  {
    if (0 == portIndex) {
      mb::utl::Segment<uint64_t> current((1 + ((0xFFF0 % 4) << 3)), (1 + ((0xFFF0 % 4) << 3)));
      mb::utl::Segment<uint64_t> intersect = transactionRange.intersect(current);
      if (!intersect.empty())
        return true;
    }
...
bool console_out_t_base::portHasRegisters(unsigned portIndex) {
  switch (portIndex) {
...
unsigned console_out_t_base::getPortCountForRegister(unsigned regIndex) {
  if (!strcmp(get_register_name(regIndex), "char_out"))
    return 1;
  if (!strcmp(get_register_name(regIndex), "char_ready"))
    return 1;
  if (!strcmp(get_register_name(regIndex), "end_sim"))
    return 1;
  return 0;
}


void console_out_t_base::getPortNamesForRegister(unsigned regIndex, const char **names) {
  long i = 0;
  if (!strcmp(get_register_name(regIndex), "char_out")) {
    names[i++] = "slave";
    return;
...
console_out_pvt::console_out_pvt(sc_module_name module_name)
  : esl::sc_sim::PVTBaseModel(module_name, 0),
    console_out_pvt_param_defaults(this->name()),
    slave("slave"),
...

{
  ...
  m_console_out_t = console_out_t_base::create_t("T", 1);
  m_console_out_pv = new console_out_pv("PV");
  bind();
}  
...
console_out_pvt::console_out_pvt(sc_module_name module_name, sc_core::sc_time clock_init, sc_core::sc_time axi_clock_init, double nominal_voltage_init, bool mb_debug_init, sc_core::sc_time mb_debug_start_time_init, sc_core::sc_time mb_debug_end_time_init, const char* mb_debug_address_read_init, const char* mb_debug_address_write_init, bool port_enable_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int slave_pipeline_length_init, unsigned int slave_outstanding_init, unsigned int slave_read_data_queue_size_init, unsigned int slave_write_data_queue_size_init)
  : esl::sc_sim::PVTBaseModel(module_name, 0),
  console_out_pvt_param_defaults(this->name(), clock_init, axi_clock_init, nominal_voltage_init, mb_debug_init, mb_debug_start_time_init, mb_debug_end_time_init, mb_debug_address_read_init, mb_debug_address_write_init, port_enable_init, call_to_default_if_init, verbose_parameters_init, dmi_enabled_init, warning_level_init, slave_pipeline_length_init, slave_outstanding_init, slave_read_data_queue_size_init, slave_write_data_queue_size_init),
    slave("slave"),
    slave_entry("unvisible_slave_entry")
...
console_out_pvt::console_out_pvt(sc_module_name module_name,  std::vector<std::pair<char*, unsigned int> > &change_parameters)
  : esl::sc_sim::PVTBaseModel(module_name, 0),
  console_out_pvt_param_defaults(this->name(), change_parameters),
    slave("slave"),
    slave_entry("unvisible_slave_entry")
...
console_out_pvt::~console_out_pvt() {
  remove_pending_scenes();
  
  delete m_console_out_t;
  
  delete m_console_out_pv;
}
...
void console_out_pvt::bind()
{
  ...
  m_console_out_t->check_mb_events();
