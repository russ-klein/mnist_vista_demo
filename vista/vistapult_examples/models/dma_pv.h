...
//This class inherits from the dma_pv_base class

class dma_pv : public dma_pv_base {
 public:
 ...
 public:
  ...
  SC_HAS_PROCESS(dma_pv);
  dma_pv(sc_core::sc_module_name module_name);  
...
private:
  void do_dma();  
  void print_buffer(unsigned int *d, unsigned int n);
};
