...
class conv_2d_pv_base_parameters {
 public :
  conv_2d_pv_base_parameters(sc_object* object);
...
class conv_2d_pv_base;


class conv_2d_pv_base_mb_compatibility : public mb::mb_module {
  friend class conv_2d_pv_base;
 public:
  typedef unsigned int mb_address_type;
 protected:
  conv_2d_pv_base_mb_compatibility(sc_core::sc_module_name& module_name)
...
class conv_2d_pv_base : public conv_2d_pv_base_mb_compatibility,
                           public conv_2d_pv_base_parameters
{
  
protected:
  mb::utl::mb_debug_handler *m_mb_debug; 
private:
  typedef conv_2d_pv_base_mb_compatibility mb_compatibility_class;
  typedef conv_2d_pv_base_mb_compatibility BASE_TYPE;
 public:
  typedef esl::tlm_types::Address mb_address_type;
 public:
  typedef conv_2d_pv_base self;
  SC_HAS_PROCESS(conv_2d_pv_base);
  conv_2d_pv_base(sc_core::sc_module_name& module_name);
  ~conv_2d_pv_base();
  virtual void reset_registers();
  virtual void reset_model();
  enum port_enum {slave_idx = 0,master_idx = 1,int_out_idx = 2 };
 private:  
 ...
 protected:
  ...
  mb::mb_register<unsigned int> go_ready;
  mb::mb_register<unsigned int> done;
  mb::mb_register<unsigned int> done_valid;
  mb::mb_register<unsigned int> image;
  mb::mb_register<unsigned int> weights;
  mb::mb_register<unsigned int> biases;
  mb::mb_register<unsigned int> output_image;
  mb::mb_register<unsigned int> num_input_images;
  mb::mb_register<unsigned int> num_output_images;
  mb::mb_register<unsigned int> height;
  mb::mb_register<unsigned int> width;
  mb::mb_register<unsigned int> filter_height;
  mb::mb_register<unsigned int> filter_width;
  mb::mb_register<unsigned int> relu;
  mb::mb_register<unsigned int> bias;
  mb::mb_register<unsigned int> maxpool;
};
...
public:
  ...
  conv_2d_RemoteRegisters(SOCKET& s, uint64_t baseAddress) :
    m_go(s[0], baseAddress, ((0) / 4), ( (0) + (((0) % 4) << 3)), ( (31) + (((0) % 4) << 3))),
    m_go_ready(s[0], baseAddress, ((4) / 4), ( (0) + (((4) % 4) << 3)), ( (31) + (((4) % 4) << 3))),
    m_done(s[0], baseAddress, ((8) / 4), ( (0) + (((8) % 4) << 3)), ( (31) + (((8) % 4) << 3))),
    m_done_valid(s[0], baseAddress, ((0xc) / 4), ( (0) + (((0xc) % 4) << 3)), ( (31) + (((0xc) % 4) << 3))),
    m_image(s[0], baseAddress, ((0x10) / 4), ( (0) + (((0x10) % 4) << 3)), ( (31) + (((0x10) % 4) << 3))),
    m_weights(s[0], baseAddress, ((0x14) / 4), ( (0) + (((0x14) % 4) << 3)), ( (31) + (((0x14) % 4) << 3))),
    m_biases(s[0], baseAddress, ((0x18) / 4), ( (0) + (((0x18) % 4) << 3)), ( (31) + (((0x18) % 4) << 3))),
    m_output_image(s[0], baseAddress, ((0x1c) / 4), ( (0) + (((0x1c) % 4) << 3)), ( (31) + (((0x1c) % 4) << 3))),
    m_num_input_images(s[0], baseAddress, ((0x20) / 4), ( (0) + (((0x20) % 4) << 3)), ( (31) + (((0x20) % 4) << 3))),
    m_num_output_images(s[0], baseAddress, ((0x24) / 4), ( (0) + (((0x24) % 4) << 3)), ( (31) + (((0x24) % 4) << 3))),
    m_height(s[0], baseAddress, ((0x28) / 4), ( (0) + (((0x28) % 4) << 3)), ( (31) + (((0x28) % 4) << 3))),
    m_width(s[0], baseAddress, ((0x2c) / 4), ( (0) + (((0x2c) % 4) << 3)), ( (31) + (((0x2c) % 4) << 3))),
    m_filter_height(s[0], baseAddress, ((0x30) / 4), ( (0) + (((0x30) % 4) << 3)), ( (31) + (((0x30) % 4) << 3))),
    m_filter_width(s[0], baseAddress, ((0x34) / 4), ( (0) + (((0x34) % 4) << 3)), ( (31) + (((0x34) % 4) << 3))),
    m_relu(s[0], baseAddress, ((0x3c) / 4), ( (0) + (((0x3c) % 4) << 3)), ( (31) + (((0x3c) % 4) << 3))),
    m_bias(s[0], baseAddress, ((0x40) / 4), ( (0) + (((0x40) % 4) << 3)), ( (31) + (((0x40) % 4) << 3))),
    m_maxpool(s[0], baseAddress, ((0x38) / 4), ( (0) + (((0x38) % 4) << 3)), ( (31) + (((0x38) % 4) << 3))),
    m_dummy(0) {}
    
public:
  mb::mb_remote_register<unsigned int, TRANS> m_go;
  mb::mb_remote_register<unsigned int, TRANS> m_go_ready;
  mb::mb_remote_register<unsigned int, TRANS> m_done;
  mb::mb_remote_register<unsigned int, TRANS> m_done_valid;
  mb::mb_remote_register<unsigned int, TRANS> m_image;
  mb::mb_remote_register<unsigned int, TRANS> m_weights;
  mb::mb_remote_register<unsigned int, TRANS> m_biases;
  mb::mb_remote_register<unsigned int, TRANS> m_output_image;
  mb::mb_remote_register<unsigned int, TRANS> m_num_input_images;
  mb::mb_remote_register<unsigned int, TRANS> m_num_output_images;
  mb::mb_remote_register<unsigned int, TRANS> m_height;
  mb::mb_remote_register<unsigned int, TRANS> m_width;
  mb::mb_remote_register<unsigned int, TRANS> m_filter_height;
  mb::mb_remote_register<unsigned int, TRANS> m_filter_width;
  mb::mb_remote_register<unsigned int, TRANS> m_relu;
  mb::mb_remote_register<unsigned int, TRANS> m_bias;
  mb::mb_remote_register<unsigned int, TRANS> m_maxpool;
private:
  int m_dummy;
};
...
template <typename TRANS = tlm::tlm_generic_payload>
class conv_2d_pv_RemoteRegisters : public conv_2d_RemoteRegisters<TRANS> {
public:
  template <class SOCKET>
  conv_2d_pv_RemoteRegisters(SOCKET& s, uint64_t baseAddress)
    : conv_2d_RemoteRegisters<TRANS>(s, baseAddress) {
  }
};
...
#define __conv_2d_t_base_CLASS_EXIST__


class conv_2d_t_base : public papoulis::SystemCBaseModel {
public:
  static conv_2d_t_base* create_t(const char* _name, long simulation); 
public:
  conv_2d_t_base(sc_core::sc_module_name& module_name, long simulation);
 
  enum port_enum {slave = 0, master = 1, int_out = 2};
...
public:
  enum register_enum {go_idx, go_ready_idx, done_idx, done_valid_idx, image_idx, weights_idx, biases_idx, output_image_idx, num_input_images_idx, num_output_images_idx, height_idx, width_idx, filter_height_idx, filter_width_idx, relu_idx, bias_idx, maxpool_idx };
protected:
  mb::mb_t_register<unsigned int> go;
  mb::mb_t_register<unsigned int> go_ready;
  mb::mb_t_register<unsigned int> done;
  mb::mb_t_register<unsigned int> done_valid;
  mb::mb_t_register<unsigned int> image;
  mb::mb_t_register<unsigned int> weights;
  mb::mb_t_register<unsigned int> biases;
  mb::mb_t_register<unsigned int> output_image;
  mb::mb_t_register<unsigned int> num_input_images;
  mb::mb_t_register<unsigned int> num_output_images;
  mb::mb_t_register<unsigned int> height;
  mb::mb_t_register<unsigned int> width;
  mb::mb_t_register<unsigned int> filter_height;
  mb::mb_t_register<unsigned int> filter_width;
  mb::mb_t_register<unsigned int> relu;
  mb::mb_t_register<unsigned int> bias;
  mb::mb_t_register<unsigned int> maxpool; 
...
class conv_2d_pvt_param_defaults {
  
public:
  conv_2d_pvt_param_defaults(const char* hier_name) {
    ...
    unsigned int master_read_data_queue_size;
    unsigned int master_write_data_queue_size;
    clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("clock", sc_core::sc_time(10, sc_core::SC_NS), hier_name ,"conv_2d");
    signal_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("signal_clock", clock, hier_name ,"conv_2d");
    axi_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("axi_clock", clock, hier_name ,"conv_2d");
    nominal_voltage = ::mb::sysc::sdInitParameter<double>("nominal_voltage", 1, hier_name ,"conv_2d");
    mb_debug = ::mb::sysc::sdInitParameter<bool>("mb_debug", false, hier_name ,"conv_2d");
    mb_debug_start_time = ::mb::sysc::sdInitParameter<sc_core::sc_time>("mb_debug_start_time", sc_core::sc_time(0, sc_core::SC_NS), hier_name ,"conv_2d");
    mb_debug_end_time = ::mb::sysc::sdInitParameter<sc_core::sc_time>("mb_debug_end_time", sc_core::sc_time(0, sc_core::SC_NS), hier_name ,"conv_2d");
    mb_debug_address_read = ::mb::sysc::sdInitParameter<const char*>("mb_debug_address_read", "0x10:0x0", hier_name ,"conv_2d");
    mb_debug_address_write = ::mb::sysc::sdInitParameter<const char*>("mb_debug_address_write", "0x10:0x0", hier_name ,"conv_2d");
    port_enable = ::mb::sysc::sdInitParameter<bool>("port_enable", true, hier_name ,"conv_2d");
    call_to_default_if = ::mb::sysc::sdInitParameter<bool>("call_to_default_if", false, hier_name ,"conv_2d");
    verbose_parameters = ::mb::sysc::sdInitParameter<bool>("verbose_parameters", true, hier_name ,"conv_2d");
    dmi_enabled = ::mb::sysc::sdInitParameter<bool>("dmi_enabled", true, hier_name ,"conv_2d");
    warning_level = ::mb::sysc::sdInitParameter<const char*>("warning_level", "WARNING", hier_name ,"conv_2d");
    slave_pipeline_length = ::mb::sysc::sdInitParameter<unsigned int>("slave_pipeline_length", 2, hier_name ,"conv_2d");
    slave_outstanding = ::mb::sysc::sdInitParameter<unsigned int>("slave_outstanding", 1, hier_name ,"conv_2d");
    slave_read_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("slave_read_data_queue_size", 0, hier_name ,"conv_2d");
    slave_write_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("slave_write_data_queue_size", 0, hier_name ,"conv_2d");
    master_outstanding = ::mb::sysc::sdInitParameter<unsigned int>("master_outstanding", 1, hier_name ,"conv_2d");
    master_read_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("master_read_data_queue_size", 0, hier_name ,"conv_2d");
    master_write_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("master_write_data_queue_size", 0, hier_name ,"conv_2d");
    ::mb::sysc::sdPropagateParameters();
  }

  conv_2d_pvt_param_defaults(const char* hier_name, sc_core::sc_time clock_init, sc_core::sc_time signal_clock_init, sc_core::sc_time axi_clock_init, double nominal_voltage_init, bool mb_debug_init, sc_core::sc_time mb_debug_start_time_init, sc_core::sc_time mb_debug_end_time_init, const char* mb_debug_address_read_init, const char* mb_debug_address_write_init, bool port_enable_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int slave_pipeline_length_init, unsigned int slave_outstanding_init, unsigned int slave_read_data_queue_size_init, unsigned int slave_write_data_queue_size_init, unsigned int master_outstanding_init, unsigned int master_read_data_queue_size_init, unsigned int master_write_data_queue_size_init) {
    ...
    unsigned int master_read_data_queue_size;
    unsigned int master_write_data_queue_size;
    clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("clock", clock_init, hier_name ,"conv_2d");
    signal_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("signal_clock", signal_clock_init, hier_name ,"conv_2d");
    axi_clock = ::mb::sysc::sdInitParameter<sc_core::sc_time>("axi_clock", axi_clock_init, hier_name ,"conv_2d");
    nominal_voltage = ::mb::sysc::sdInitParameter<double>("nominal_voltage", nominal_voltage_init, hier_name ,"conv_2d");
    mb_debug = ::mb::sysc::sdInitParameter<bool>("mb_debug", mb_debug_init, hier_name ,"conv_2d");
    mb_debug_start_time = ::mb::sysc::sdInitParameter<sc_core::sc_time>("mb_debug_start_time", mb_debug_start_time_init, hier_name ,"conv_2d");
    mb_debug_end_time = ::mb::sysc::sdInitParameter<sc_core::sc_time>("mb_debug_end_time", mb_debug_end_time_init, hier_name ,"conv_2d");
    mb_debug_address_read = ::mb::sysc::sdInitParameter<const char*>("mb_debug_address_read", mb_debug_address_read_init, hier_name ,"conv_2d");
    mb_debug_address_write = ::mb::sysc::sdInitParameter<const char*>("mb_debug_address_write", mb_debug_address_write_init, hier_name ,"conv_2d");
    port_enable = ::mb::sysc::sdInitParameter<bool>("port_enable", port_enable_init, hier_name ,"conv_2d");
    call_to_default_if = ::mb::sysc::sdInitParameter<bool>("call_to_default_if", call_to_default_if_init, hier_name ,"conv_2d");
    verbose_parameters = ::mb::sysc::sdInitParameter<bool>("verbose_parameters", verbose_parameters_init, hier_name ,"conv_2d");
    dmi_enabled = ::mb::sysc::sdInitParameter<bool>("dmi_enabled", dmi_enabled_init, hier_name ,"conv_2d");
    warning_level = ::mb::sysc::sdInitParameter<const char*>("warning_level", warning_level_init, hier_name ,"conv_2d");
    slave_pipeline_length = ::mb::sysc::sdInitParameter<unsigned int>("slave_pipeline_length", slave_pipeline_length_init, hier_name ,"conv_2d");
    slave_outstanding = ::mb::sysc::sdInitParameter<unsigned int>("slave_outstanding", slave_outstanding_init, hier_name ,"conv_2d");
    slave_read_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("slave_read_data_queue_size", slave_read_data_queue_size_init, hier_name ,"conv_2d");
    slave_write_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("slave_write_data_queue_size", slave_write_data_queue_size_init, hier_name ,"conv_2d");
    master_outstanding = ::mb::sysc::sdInitParameter<unsigned int>("master_outstanding", master_outstanding_init, hier_name ,"conv_2d");
    master_read_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("master_read_data_queue_size", master_read_data_queue_size_init, hier_name ,"conv_2d");
    master_write_data_queue_size = ::mb::sysc::sdInitParameter<unsigned int>("master_write_data_queue_size", master_write_data_queue_size_init, hier_name ,"conv_2d");

    ::mb::sysc::sdPropagateParameters();
    }

  conv_2d_pvt_param_defaults(const char* hier_name, std::vector<std::pair<char*, unsigned int> > &change_parameters){
    ...
    for (unsigned i =0; i<change_parameters.size(); i++){
      ::mb::sysc::sdInitParameter<unsigned int>(change_parameters[i].first, change_parameters[i].second, hier_name ,"conv_2d");
    }
...
class conv_2d_pvt : public esl::sc_sim::PVTBaseModel, 
                          public mb::utl::cb_owner,
                          private conv_2d_pvt_param_defaults {

 public:
  typedef conv_2d_pvt self_type;

 public: 
  // Constructor
  conv_2d_pvt(sc_core::sc_module_name module_name); 
  conv_2d_pvt(sc_core::sc_module_name module_name, sc_core::sc_time clock_init, sc_core::sc_time signal_clock_init, sc_core::sc_time axi_clock_init, double nominal_voltage_init, bool mb_debug_init, sc_core::sc_time mb_debug_start_time_init, sc_core::sc_time mb_debug_end_time_init, const char* mb_debug_address_read_init, const char* mb_debug_address_write_init, bool port_enable_init, bool call_to_default_if_init, bool verbose_parameters_init, bool dmi_enabled_init, const char* warning_level_init, unsigned int slave_pipeline_length_init, unsigned int slave_outstanding_init, unsigned int slave_read_data_queue_size_init, unsigned int slave_write_data_queue_size_init, unsigned int master_outstanding_init, unsigned int master_read_data_queue_size_init, unsigned int master_write_data_queue_size_init); 
  conv_2d_pvt(sc_core::sc_module_name module_name, std::vector<std::pair<char*, unsigned int> > &change_parameters);
  ~conv_2d_pvt(); 
 ...
 public:
  ...
  inline conv_2d_t_base* getT() const {
    return m_conv_2d_t;
  }

  
  //access the PV instance
  inline conv_2d_pv* getPV() const {
    return m_conv_2d_pv;
  }
 ...
 private:
  ...
  void b_transport_outside_int_out(bool data); 

 private:
  
  
  //T instance
  conv_2d_t_base* m_conv_2d_t;
  
  
  //PV instance
  conv_2d_pv* m_conv_2d_pv;
 ...
 public:
  ...
  slave_type slave;
  esl::sc_sim::pvt_initiator_socket<1, tlm::tlm_base_protocol_types, 1, sc_core::SC_ZERO_OR_MORE_BOUND>  int_out;
 ...
 private:
  ...
  esl::sc_sim::signal_out<bool > int_out_entry;  
 ...
 private:
  ...
  struct master_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    ...
    master_nb_connector(conv_2d_pvt& owner) : m_owner(owner) {
    }
  ...
  struct int_out_nb_connector : public tlm::tlm_fw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    conv_2d_pvt& m_owner;
    
    int_out_nb_connector(conv_2d_pvt& owner) : m_owner(owner) {
    }
    virtual tlm::tlm_sync_enum nb_transport_fw(tlm::tlm_generic_payload& trans, 
                                               tlm::tlm_phase& phase, 
                                               sc_core::sc_time& t) {
      return m_owner.int_out.nb_transport_fw((tlm::tlm_base_protocol_types::tlm_payload_type&)trans, phase, t);
    }
    virtual ::mb::tlm20::socket_tracer *get_socket_tracer() {
      return &m_owner.int_out;
    }
  };
  friend struct int_out_nb_connector;
  int_out_nb_connector m_int_out_nb_connector;
  ...
  struct slave_nb_connector : public tlm::tlm_bw_nonblocking_transport_if<>, public ::mb::tlm20::socket_tracer_holder {
    ...
    slave_nb_connector(conv_2d_pvt& owner) : m_owner(owner) {
    }
  ...
  tlm::tlm_sync_enum receive_nb_transport_int_out(tlm::tlm_generic_payload& trans,
                                                       tlm::tlm_phase& phase,
                                                    sc_core::sc_time& t) {
