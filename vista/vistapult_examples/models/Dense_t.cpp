...
//*
//* This file contains the timing class for Dense.
//*
...
#ifdef __Dense_t_base_CLASS_EXIST__
#include <iostream>
...
Dense_t_base* Dense_t_base::create_t(const char* name, long simulation) {
  return new Dense_t(name, simulation);
}


Dense_t::Dense_t(sc_module_name _name, long simulation)
  : Dense_t_base(_name, simulation) {
